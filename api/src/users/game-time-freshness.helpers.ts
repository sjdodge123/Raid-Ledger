 ...
 * confirmed more than {@link GAME_TIME_FRESHNESS_DAYS} days ago (ROK-999; widened 2026-09-15 and 2026-09-16).
 ...
 * 7 → 14 on 2026-09-15, 14 → 30 on 2026-09-16 (operator rulings): most
 * members set game time and leave it, so a short window made nearly every
 * poll heatmap read as stale and the refresh nag fired too eagerly.
 * ROK-1564's one-tap "Looks right" re-stamps the confirmation cheaply.
 */
export const GAME_TIME_FRESHNESS_DAYS = 30;

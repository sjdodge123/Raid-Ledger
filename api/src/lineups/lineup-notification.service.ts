...
export class LineupNotificationService {
  ...
  async notifyVotingOpen(lineup: LineupInfo, gameCount: number): Promise<void> {
    await this.postVotingChannelEmbed(lineup, gameCount);
    await this.sendVotingDMs(lineup, gameCount);
  }

...
describe('ChannelBindingsController — listBindings: empty/missing', () => {
...
describe('ChannelBindingsController — listBindings: enrichment', () => {
...
describe('ChannelBindingsController — listBindings: DTO mapping', () => {
...
describe('ChannelBindingsController — createBinding: validation', () => {
...
describe('ChannelBindingsController — createBinding: DTO shape', () => {
...
describe('ChannelBindingsController — createBinding: arguments', () => {
...
describe('ChannelBindingsController — updateBinding: validation', () => {
...
describe('ChannelBindingsController — updateBinding: success', () => {
...
describe('ChannelBindingsController — deleteBinding', () => {
  it('should throw NotFoundException when binding does not exist', async () => {

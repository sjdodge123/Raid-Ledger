...
ALTER TABLE "discord_channel_presence_messages" ADD CONSTRAINT "discord_channel_presence_messages_binding_id_channel_bindings_id_fk" FOREIGN KEY ("binding_id") REFERENCES "public"."channel_bindings"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint

...
ALTER TABLE "community_lineups" ADD CONSTRAINT "community_lineups_tie_pick_by_users_id_fk" FOREIGN KEY ("tie_pick_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint

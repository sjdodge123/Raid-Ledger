...
/**
 * Integrations > Discord OAuth panel.
 * ROK-281: Wraps existing IntegrationCard + DiscordOAuthForm.
 */
export function DiscordPanel() {
    const { oauthStatus } = useAdminSettings();

    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-xl font-semibold text-foreground">Discord OAuth</h2>
                <p className="text-sm text-muted mt-1">Configure Discord login for your community.</p>
            </div>
            <IntegrationCard
                title="Discord OAuth"

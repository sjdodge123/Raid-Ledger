...
/**
 * Integrations > Discord panel — consolidated OAuth + Bot + Channel Bindings.
 * ROK-359: Merged from three separate panels into one.
 */
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-muted mt-1">Manage OAuth login, bot configuration, and channel bindings.</p>
            </div>
            ...
            <div className="space-y-4">
                <div>
                    <h3 className="text-lg font-semibold text-foreground">Channel Bindings</h3>
                    <p className="text-sm text-muted mt-1">
                ...
                {!isBotConnected && (
                    <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                        <p className="text-sm text-amber-400">
                            The Discord bot is not connected. Configure it above to manage channel bindings.
                        </p>
                    </div>
                )}

...
export function DiscordConnectionPage() {
    ...
    return <DiscordConnectionContent />;
}
...
function DiscordConnectionContent() {
    ...
    return (
        <div className="space-y-6">
            ...
            {!hasDiscord ? (
                <LinkDiscordPrompt icon={DiscordIcon} onLink={handleLinkDiscord} />
            ) : (
                <IntegrationCard
                    title="Discord Bot"
...
function LinkDiscordPrompt({ icon, onLink }: { icon: React.ReactNode; onLink: () => void }) {
    return (

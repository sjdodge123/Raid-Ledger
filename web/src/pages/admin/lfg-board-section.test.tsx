...
describe('LfgBoardSection — composer follows the board (ROK-1658)', () => {
    it('has no separate composer switch — the composer follows the board (ROK-1658)', () => {
        state.status.data = { enabled: true };
        renderSection();
        expect(screen.queryByLabelText('Pin the LFG composer card')).toBeNull();

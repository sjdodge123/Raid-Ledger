...
function DiscordAuthContent() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-xl font-semibold text-foreground">Discord Authentication</h2>
                <p className="text-sm text-muted mt-1">Configure OAuth credentials to enable Discord login for users.</p>
            </div>

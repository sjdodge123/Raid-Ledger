    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-surface border border-edge-subtle rounded-xl p-6">
                ...
                {/* Steam account linking (ROK-417) */}
                {steamStatus.data?.linked ? (
                    <div className="mt-4 p-4 bg-panel rounded-lg border border-edge">
                        <div className="flex items-center justify-between gap-4">
                                ...
                                <div>
                                    <div className="flex items-center gap-2">
                                        <span className="text-sm font-medium text-foreground">
                                            {steamStatus.data.personaName || 'Steam Linked'}
                                        </span>
                            ...
                            <div className="flex items-center gap-2 flex-shrink-0">
                                ...
                                <button
                                    onClick={() => unlinkSteam.mutate()}
                                    disabled={unlinkSteam.isPending}
                    ...
                    <div className="mt-4 p-4 bg-panel rounded-lg border border-edge">
                        ...
                        <button
                            onClick={linkSteam}
                            className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#1B2838] hover:bg-[#2a475e] text-white font-medium rounded-lg transition-colors"
                        >

...
export function CreateEventPage() {
  ...
  const { games: registryGames, isLoading: registryLoading } =
    useGameRegistry();
  ...
  const schedulingMatchId = searchParams.get("matchId")
    ? parseInt(searchParams.get("matchId")!, 10)
    : null;
  ...
  const followupForEventId = searchParams.get("followupForEventId")
    ? parseInt(searchParams.get("followupForEventId")!, 10)
    : null;
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-surface border border-edge-subtle rounded-xl p-6">
          <CreateEventForm
            ...
            followupForEventId={followupForEventId}
          />
        </div>
      </div>
    </div>

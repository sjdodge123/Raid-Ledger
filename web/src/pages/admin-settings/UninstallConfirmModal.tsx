    ...
    return (
        <Modal isOpen={!!plugin} onClose={onClose} title="Uninstall Plugin">
            <div className="space-y-4">
                ...
                <UninstallDeletionWarning />
                <ConfiguredIntegrationsWarning integrations={configuredIntegrations} />
                <UninstallActions onClose={onClose} onConfirm={onConfirm} isPending={isPending} />
            </div>
        </Modal>
    );
}
...
function ConfiguredIntegrationsWarning({ integrations }: {
...
function UninstallActions({ onClose, onConfirm, isPending }: {

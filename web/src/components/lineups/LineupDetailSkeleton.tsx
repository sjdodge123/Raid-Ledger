...
/**
 * role="status" + aria-label name the skeleton in Playwright's aria snapshot
 * (error-context.md omits data-testid), so a hung lineup query reads as
 * "Loading lineup" rather than an anonymous `generic`.
 */
export function LineupDetailSkeleton(): JSX.Element {
  return (
    <div
      data-testid="lineup-detail-skeleton"
      role="status"

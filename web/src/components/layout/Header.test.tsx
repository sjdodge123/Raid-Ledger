...
describe('Header — skip link (AC: Skip link appears on Tab from top of page)', () => {
...
describe('Header — nav aria-label (AC: Semantic landmarks added to layout)', () => {
...
describe('Header — community name', () => {

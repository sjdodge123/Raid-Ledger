        ...
        <>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mb-6">
                ...
                <ul className="text-xs text-secondary space-y-0.5 list-disc list-inside ml-2">
                    ...
                    <li className="ml-4"><strong>General:</strong> <em>Manage Roles</em>, <em>Manage Channels</em>, <em>Manage Guild Expressions</em>, <em>Create Guild Expressions</em>, <em>Create Instant Invite</em>, <em>View Channels</em></li>

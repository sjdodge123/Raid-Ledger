          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full max-w-md px-4 py-2.5 bg-surface/50 border rounded-lg text-foreground placeholder:text-dim focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all text-sm ${
            ...
            <button
              ...
              className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 disabled:bg-emerald-800 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-colors text-sm"
            >
              {changePassword.isPending
                ? 'Changing...'
                : 'Change Password'}

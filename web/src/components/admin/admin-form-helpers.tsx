    ...
    return (
        <div className="relative cursor-pointer group" onClick={copyValue}>
            <input type="text" value={value} readOnly onKeyDown={handleKeyDown}
                className="w-full px-4 py-3 bg-surface/50 border border-edge rounded-lg text-foreground cursor-pointer select-all focus:outline-none focus-visible:ring-2 focus-visible:ring-success/50 group-hover:border-dim transition-all text-sm" />

                                            ...
                                            <div className="flex items-center justify-end gap-1">
                                                {game.banned ? (
                                                    <button
                                                        onClick={() => handleUnban(game.id)}
                                                        disabled={unbanGame.isPending}
                                                        className="w-11 h-11 md:w-9 md:h-9 flex items-center justify-center rounded-md text-emerald-400 hover:text-emerald-300 hover:bg-emerald-500/10 disabled:opacity-50 transition-colors"
                                                        title="Unban game"
                                                        aria-label="Unban game"
                                                    >
                                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <button
                                                        onClick={() => handleHide(game.id)}
                                                        disabled={hideGame.isPending}
                                                        className="w-11 h-11 md:w-9 md:h-9 flex items-center justify-center rounded-md text-yellow-400 hover:text-yellow-300 hover:bg-yellow-500/10 disabled:opacity-50 transition-colors"
                                                        title="Hide game from users"
                                                        aria-label="Hide game from users"
                                                    >
                                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                {!game.banned && (
                                                    <button
                                                        onClick={() => handleDelete(game.id, game.name)}
                                                        disabled={banGame.isPending}
                                                        className="w-11 h-11 md:w-9 md:h-9 flex items-center justify-center rounded-md text-red-400 hover:text-red-300 hover:bg-red-500/10 disabled:opacity-50 transition-colors"
                                                        title="Remove game"
                                                        aria-label="Remove game"
                                                    >
                                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

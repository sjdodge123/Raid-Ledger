 ...
 * Feature-level signal (ROK-1475): shows a warning when a newer GitHub
 * release exists than the running semver. The build-level `fix:` count
 * lives in BuildFixesNotice, not here.

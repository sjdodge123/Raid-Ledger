...
function eventattendancedonutGroup1() {
...
function eventattendancedonutGroup2() {
...
function eventattendancedonutGroup3() {
...
describe('EventAttendanceDonut', () => {
    eventattendancedonutGroup1();
    eventattendancedonutGroup2();
    eventattendancedonutGroup3();
});

...
export function CharacterCard({ character, onEdit }: CharacterCardProps) {
    ...
    return (
        <div className="bg-panel border border-edge rounded-lg">
            {/* Top row: character info + actions toggle */}
            <div className="p-4 flex items-center justify-between gap-4">
                ...
                {/* Actions — mobile: kebab toggle, desktop: inline buttons */}
            ...
            {/* Mobile accordion actions panel */}
            {menuOpen && (
                <div className="md:hidden border-t border-edge" data-testid="mobile-actions-panel">
                    <div className="flex items-center justify-evenly px-2 py-1">
                        ...
                        <button
                            ...
                            className="min-w-[44px] min-h-[44px] px-4 py-2 text-sm text-secondary hover:text-foreground hover:bg-overlay rounded transition-colors"
                        >
                            Edit
                        </button>
                        <button
                            ...
                            disabled={deleteMutation.isPending}
                            className="min-w-[44px] min-h-[44px] px-4 py-2 text-sm text-red-400 hover:text-red-300 hover:bg-red-950/50 rounded transition-colors"
                        >
                            Delete
                        </button>
                    </div>

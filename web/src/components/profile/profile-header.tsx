...
/**
 * Compact profile header strip.
 * Handles Discord link search params, avatar modal, and Discord details modal.
 * No avatar edit pencil (ROK-290 feedback).
 */
export function ProfileHeader({ user, characters, onRefresh }: ProfileHeaderProps) {
    ...
    return (
        <>
            {/* Compact header strip — no edit pencil for avatar (ROK-290) */}
            <div className="bg-surface border border-edge-subtle rounded-xl p-4 my-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                        <button
                            type="button"
                            onClick={hasDiscordLinked ? () => setShowDiscordModal(true) : handleLinkDiscord}

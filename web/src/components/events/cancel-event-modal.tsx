    ...
    return (
        <div>
            ...
            <textarea id="cancel-reason" value={reason} onChange={(e) => onChange(e.target.value)}
                ...
                className="w-full bg-panel border border-edge rounded-lg px-3 py-2 text-sm text-foreground placeholder:text-dim focus:outline-none focus:ring-2 focus:ring-success/50 resize-none" />

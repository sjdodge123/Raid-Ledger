...
/**
 * AdHocRoster — Real-time participant list for ad-hoc events (ROK-293).
 * Shows active/left participants with join time and duration.
 */
export function AdHocRoster({ participants, activeCount }: AdHocRosterProps) {

    ...
    return (
        <div className="w-32 h-32 mb-6 relative">
            <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                <rect x="20" y="30" width="80" height="70" rx="8" className="fill-slate-800 stroke-slate-600" strokeWidth="2" />
                <rect x="20" y="30" width="80" height="20" rx="8" className="fill-emerald-600" />
                <rect x="20" y="42" width="80" height="8" className="fill-emerald-600" />
                ...
                <path d="M15 45 L18 50 L15 55 L12 50 Z" className="fill-yellow-400" />
                <path d="M105 55 L108 60 L105 65 L102 60 Z" className="fill-yellow-400" />
...
export function EventsEmptyState() {
    ...
    return (
        <div className="col-span-full flex flex-col items-center justify-center py-16 px-4">
            ...
            {isAuthenticated ? <CreateEventButton /> : <p className="text-sm text-dim">Sign in to create events</p>}
        </div>
    );
}

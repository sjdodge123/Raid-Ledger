        ...
        >
            ...
            >
                ...
                {showSuccess ? <SuccessState /> : (
                    <FeedbackForm
                        category={category} message={message} includeClientLogs={includeClientLogs}
    ...
    return (
        <>
            ...
            <div className="mb-4">
                ...
                <textarea value={message} onChange={(e) => onMessageChange(e.target.value)} placeholder="Tell us what's on your mind..." rows={4} maxLength={MAX_LENGTH}
            ...
            <p className="mb-4 flex items-center gap-1 text-xs" style={{ color: 'var(--color-muted)' }}>🛡️ Feedback is tracked via Sentry error monitoring.</p>
            {(isError || sentryError) && (

...
const FeedbackButton = ({ onClick }: { onClick: () => void }) => (
    <button onClick={onClick} className="hidden md:flex fixed bottom-6 right-6 z-40 h-12 w-12 items-center justify-center rounded-full shadow-lg transition-all hover:scale-110 active:scale-95 bg-emerald-600 hover:bg-emerald-500 text-white"

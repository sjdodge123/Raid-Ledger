...
- **"In Review"**: Waiting on operator testing. Offer to deploy for testing and resume from **Step 6e** (deploy for operator testing) and **Step 7a** (poll for operator results).
